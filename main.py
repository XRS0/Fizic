...
def calculate_temperature_change(mass_processor, specific_heat_processor, mass_cooler, specific_heat_cooler):
    ...
    # При условии, что процессор выключается при температуре 100 ˚C
    max_temperature = 100
...
# Создание таблицы данных с введенными данными
data = {
...
# Рассчитываем изменение температуры и добавляем в ранее созданную таблицу данных
